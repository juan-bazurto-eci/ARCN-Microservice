...
class ClientServiceTest {
        ...
        public void testLogin() {
                ...
                AuthorizationResponse expectedResponse = new AuthorizationResponse(
                                ...
                                new ClientResponseDTO("a", "miguels007", "John", "Doe", "miguel@example.com",
                                                "colombia",
                                                "3132105755", birthDate, shippingAddress, paymentMethod));
        ...
        @Test
        void Should_ReturnFalse_IfPaymentMethodIsInvalid() {
                assertFalse(clientService.isPaymentMethodValid(new PaymentMethod("1", "07/26", "Migue", "123")));
                assertFalse(clientService
                                .isPaymentMethodValid(new PaymentMethod("5429264884032453", "07/21", "Migue", "123")));
                assertFalse(clientService
                                .isPaymentMethodValid(new PaymentMethod("5429264884032453", "07/28", "Migue", null)));
                assertFalse(clientService
                                .isPaymentMethodValid(new PaymentMethod("5429264884032453", "07/28", "Migue", "12")));
        }

        @Test
        void Should_ReturnTrue_IfPaymentMethodIsValid() {
